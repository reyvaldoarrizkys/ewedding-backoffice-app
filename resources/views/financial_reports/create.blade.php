...
<div class="max-w-2xl bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
    <div class="p-6 border-b border-slate-100 bg-slate-50/50">
        <h3 class="text-lg font-semibold text-slate-800 font-heading">Form Transaksi Laporan Keuangan</h3>
    </div>
    
    <form action="{{ route('financial-reports.store') }}" method="POST" class="p-6 space-y-5">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div class="md:col-span-2">
                ...
                <input type="number" name="jumlah" id="jumlah" value="{{ old('jumlah') }}" required min="1" step="1"
                    class="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-gold focus:border-gold outline-none transition-colors"
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="deskripsi" id="deskripsi" value="{{ old('deskripsi') }}" required
                    class="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-gold focus:border-gold outline-none transition-colors"
                    placeholder="Contoh: DP 50% untuk pesanan Ayu & Budi">
            ...
            <div class="md:col-span-2">
                ...
                <p class="text-xs text-slate-500 mt-1">*Jika ini pemasukan dari pesanan, kaitkan dengan nomor pesanan di sini.</p>
